...
int DBCreateFile(char* filename)
{
	...
	DB_List filehead(-1, -1, 0, 0);
	char* fileheadchar = new char[sizeof(filehead)];
	memcpy(fileheadchar, &filehead, sizeof(filehead));
	::exstrcpy((char*)filehdr.fixed, fileheadchar, 0, 0, sizeof(filehead));
	DB_List* ll = (DB_List*)::getsubstr((char*)filehdr.fixed, 0, sizeof(filehead));
